...
"""
    ...
    May 21, 2014
    ------------
    Syntax changes by Nicco Kunzmann:
     - Made ping.py run under Python 3.
...
def checksum(source_string):
    ...
    """
    if not isinstance(source_string[0], int):
        source_string = list(map(ord, source_string))
    sum = 0
